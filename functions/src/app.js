...
app.post("/approve-all", async (_req, res) => {
  try {
    const snap = await db
      .collection("requests")
...
// Endpoint 7: Edit extracted fields
...
// Volunteer-side: accept the assignment
...
// Volunteer-side: complete the mission
